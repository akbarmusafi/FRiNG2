...
export default function Home() {
  ...
  const usdcDemoContract = "0x006eAd1914D1579e2e575b81B81Cf3DbB4a02e77"; //replace with the contract address you created
  ...
  return (
    ...
    >
      ...
      <h1 style={{ textAlign: "center", color: "black" }}>Donate with USDC</h1>
                ...
                <>
                  <div style={{ margin: "10px" }}>
                    <input
                      ...
                      type="text"
                      placeholder="Wallet Address to donate USDC to"
